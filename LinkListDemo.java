...
class List
{
    ...
    List insertAfter(List list, int olddata, int newdata)
    {
        Node newnode=new Node(newdata);
        Node currnode=list.head;

        if(currnode!=null && currnode.key==olddata)
        {
            newnode.next=currnode.next;
            list.head=newnode;
        }
        while(currnode!=null && currnode.key!=olddata)
        {
            currnode=currnode.next;
        }
        System.out.println("key is "+currnode.key);
        newnode.next=currnode.next;
